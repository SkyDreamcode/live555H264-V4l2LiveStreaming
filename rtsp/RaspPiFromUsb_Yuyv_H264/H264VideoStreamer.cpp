...
int main(int argc, char** argv) {
  ...
  if(0 == fork())
  {
	...
	while(1)
	{
		...
		delta_time = 1000000l*(end.tv_sec - begin.tv_sec) + (end.tv_usec-begin.tv_usec);
		printf("getnextframe delta-time:%ld us\n", delta_time);
	}
...
void play() {
  ...
  videoSource = H264VideoStreamFramer::createNew(*env, videoES, 0);
